...
library(tidyverse)
mecha_mpg <- read.csv(file='D:/generalCode/R/MechaCar_Statistical_Analysis/Resources/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file='D:/generalCode/R/MechaCar_Statistical_Analysis/Resources/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
